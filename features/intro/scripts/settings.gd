...
onready var container = $content/grid/container
onready var checkbox_display_fps = $content/grid/container/video/grid_video/hbox_display_fps/button_display_fps/check_box
onready var button_video = $content/grid/hmenu/button_video
onready var button_audio = $content/grid/hmenu/button_audio

# SUPORTE A TRADUÇÃO DE ELEMENTOS.
onready var nav_title = $content/grid/navigation/title
onready var button_display_fps = $content/grid/container/video/grid_video/hbox_display_fps/button_display_fps
